package Selenium.TestCase.Mari;
...
public class Dashboard_Mari {
	...
	public void Before() {
		...
		driver.findElement(By.id("username")).sendKeys("gokuls2381@gmail.com");
		//Password :Leaf$1234
		driver.findElement(By.id("password")).sendKeys("Roulette@123");
